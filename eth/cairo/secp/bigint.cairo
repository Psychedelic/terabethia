...
func from_felt{range_check_ptr}(num : felt) -> (res : BigInt3):
    let (m1, r1) = unsigned_div_rem(num, BASE)
    let (m2, r2) = unsigned_div_rem(r1, BASE)
    let (m3, r3) = unsigned_div_rem(r2, BASE)

    let res = BigInt3(m1, m2, m3)
