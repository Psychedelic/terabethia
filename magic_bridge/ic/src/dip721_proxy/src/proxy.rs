...
pub const ERC721_ADDRESS_ETH: &str = "0x15b661f6d3fd9a7ed8ed4c88bccfd1546644443f";
...
mod tests {
    ...
    #[test]
    fn test_store_erc721_incoming_message() {
